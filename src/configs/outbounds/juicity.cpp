...
namespace Configs {
    ...
    QString juicity::ExportToLink() const
    {
        QUrl url;
        QUrlQuery query;
    ...
    QJsonObject juicity::ExportToJson() const
    {
        QJsonObject object;
        object["type"] = "juicity";
    ...
    BuildResult juicity::Build() const
    {
        QJsonObject object;
        object["type"] = "juicity";
    ...
    QString juicity::DisplayType() const
    {
        return "Juicity";
    }

    SecurityInfo juicity::GetSecurity() const
    {
