...
namespace Configs {
    bool anyTLS::ParseFromLink(const QString& link)
    {
        ...
        if (query.hasQueryItem("min_idle_session")) min_idle_session = parseIntOr(query.queryItemValue("min_idle_session"), min_idle_session);
    ...
    QString anyTLS::ExportToLink() const
    {
        QUrl url;
        QUrlQuery query;
    ...
    QJsonObject anyTLS::ExportToJson() const
    {
        QJsonObject object;
        object["type"] = "anytls";
    ...
    BuildResult anyTLS::Build() const
    {
        QJsonObject object;
        object["type"] = "anytls";
    ...
    QString anyTLS::DisplayType() const
    {
        return "AnyTLS";
    }
}
