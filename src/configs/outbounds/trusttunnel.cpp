...
namespace Configs {
    ...
    QString trusttunnel::ExportToLink() const
    {
        QUrl url;
        QUrlQuery query;
        url.setScheme("tt");
    ...
    QJsonObject trusttunnel::ExportToJson() const
    {
        QJsonObject object;
    ...
    BuildResult trusttunnel::Build() const
    {
        QJsonObject object;
        object["type"] = "trusttunnel";
    ...
    QString trusttunnel::DisplayType() const
    {
        return "TrustTunnel";
    }

    SecurityInfo trusttunnel::GetSecurity() const
    {
