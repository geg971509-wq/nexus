...
namespace Configs {
    ...
    QString tuic::ExportToLink() const
    {
        QUrl url;
        QUrlQuery query;
        url.setScheme("tuic");
    ...
    QJsonObject tuic::ExportToJson() const
    {
        QJsonObject object;
        object["type"] = "tuic";
    ...
    QString tuic::DisplayType() const
    {
        return "TUIC";
    }

    SecurityInfo tuic::GetSecurity() const
    {
