...
namespace Configs {
    ...
    QString tailscale::ExportToLink() const
    {
        QUrl url;
        QUrlQuery query;
        url.setScheme("ts");
    ...
    QJsonObject tailscale::ExportToJson() const
    {
        QJsonObject object;
    ...
    BuildResult tailscale::Build() const
    {
        QJsonObject object;
        object["type"] = "tailscale";
        if (!state_directory.isEmpty()) object["state_directory"] = state_directory;
    ...
    QString tailscale::GetAddress() const {
        return control_url;
    }

    QString tailscale::DisplayAddress() const
    {
        return control_url;
    }

    QString tailscale::DisplayType() const
    {
        return "Tailscale";
    }

    SecurityInfo tailscale::GetSecurity() const
    {
        return {QObject::tr("Encrypted"), "WireGuard", SecurityLevel::Secure};
    }

    bool tailscale::IsEndpoint() const
    {
        return true;
    }
}
