...
namespace Configs {
    ...
    QString ssh::ExportToLink() const
    {
        QUrl url;
        QUrlQuery query;
        url.setScheme("ssh");
    ...
    QJsonObject ssh::ExportToJson() const
    {
        QJsonObject object;
        object["type"] = "ssh";
    ...
    QString ssh::DisplayType() const
    {
        return "SSH";
    }

    SecurityInfo ssh::GetSecurity() const
    {
