...
namespace Configs {
    bool socks::ParseFromLink(const QString& link)
    {
        ...
        // Default port
        if (server_port == 0) server_port = DEFAULT_SOCKS_PORT;
    ...
    QString socks::ExportToLink() const
    {
        QUrl url;
        QUrlQuery query;
    ...
    QJsonObject socks::ExportToJson() const
    {
        QJsonObject object;
        object["type"] = "socks";
    ...
    QString socks::DisplayType() const
    {
        return "Socks";
    }
}
