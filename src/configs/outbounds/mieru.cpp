...
namespace Configs {
    ...
    QString mieru::ExportToLink() const
    {
    ...
    QJsonObject mieru::ExportToJson() const
    {
        QJsonObject object;
        object["type"] = "mieru";
    ...
    QString mieru::DisplayType() const
    {
        return "Mieru";
    }

    SecurityInfo mieru::GetSecurity() const
    {
