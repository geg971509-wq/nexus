...
namespace Configs {
    ...
    QString naive::ExportToLink() const
    {
        QUrl url;
        QUrlQuery query;
    ...
    QJsonObject naive::ExportToJson() const
    {
        QJsonObject object;
        object["type"] = "naive";
    ...
    QString naive::DisplayType() const
    {
        return "Naive";
    }

    SecurityInfo naive::GetSecurity() const
    {
