...
namespace Configs {
    bool Transport::ParseFromLink(const QString& link)
    {
        ...
        if (query.hasQueryItem("max_early_data")) max_early_data = parseIntOr(query.queryItemValue("max_early_data"), max_early_data);
    ...
    QString Transport::ExportToLink() const
    {
        QUrlQuery query;
    ...
    QJsonObject Transport::ExportToJson() const
    {
        QJsonObject object;
    ...
    QJsonObject Transport::ExportIdentity() const
    {
        QJsonObject object;
        if (type.isEmpty() || type == "tcp") return object;
        object["type"] = type;
    ...
    BuildResult Transport::Build() const
    {
        return {ExportToJson(), ""};
    }
}
