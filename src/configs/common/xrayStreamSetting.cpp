...
namespace Configs {
    ...
    QString xrayTLS::ExportToLink() const {
        QUrlQuery query;
    ...
    QJsonObject xrayTLS::ExportToJson() const {
        QJsonObject object;
    ...
    BuildResult xrayTLS::Build() const {
    ...
    QString xrayReality::ExportToLink() const {
        QUrlQuery query;
        query.addQueryItem("sni", serverName);
        if (!fingerprint.isEmpty()) query.addQueryItem("fp", fingerprint);
    ...
    QJsonObject xrayReality::ExportToJson() const {
        QJsonObject object;
        object["serverName"] = serverName;
        if (!fingerprint.isEmpty()) object["fingerprint"] = fingerprint;
    ...
    BuildResult xrayReality::Build() const {
        auto obj = ExportToJson();
        if (fingerprint.isEmpty() && !Configs::dataManager->settingsRepo->utlsFingerprint.isEmpty()) obj["fingerprint"] = Configs::dataManager->settingsRepo->utlsFingerprint;
        return {obj, ""};
    }
    ...
    QString xrayXHTTP::ExportToLink() const {
        QUrlQuery query;
    ...
    QJsonObject xrayXHTTP::ExportToJson() const {
        QJsonObject obj;
    ...
    BuildResult xrayXHTTP::Build() const {
        return {ExportToJson(), ""};
    }
    ...
    bool xrayWS::ParseFromLink(const QString &link) {
        ...
        if (query.hasQueryItem("host")) host = query.queryItemValue("host");
        if (query.hasQueryItem("path")) path = query.queryItemValue("path", QUrl::FullyDecoded);
        if (query.hasQueryItem("ed")) ed = parseIntOr(query.queryItemValue("ed"), ed);
        if (query.hasQueryItem("headers")) {
            auto raw = query.queryItemValue("headers", QUrl::FullyDecoded);
            headers = raw.split("|");
            if (headers.length()%2 != 0) {
        ...
        if (query.hasQueryItem("heartbeat_period")) heartbeatPeriod = parseIntOr(query.queryItemValue("heartbeat_period"), heartbeatPeriod);
        return true;
    }
    ...
    QString xrayWS::ExportToLink() const {
        QUrlQuery query;
        if (!host.isEmpty()) query.addQueryItem("host", host);
    ...
    QJsonObject xrayWS::ExportToJson() const {
        QJsonObject obj;
        if (!path.isEmpty()) {
            auto fullPath = path;
    ...
    BuildResult xrayWS::Build() const {
        return {ExportToJson(), ""};
    }
    ...
    QString xrayHttpUpgrade::ExportToLink() const {
        QUrlQuery query;
        if (!host.isEmpty()) query.addQueryItem("host", host);
        if (!path.isEmpty() && path != "/") query.addQueryItem("path", path);
        if (ed > 0) query.addQueryItem("ed", QString::number(ed));
    ...
    QJsonObject xrayHttpUpgrade::ExportToJson() const {
        QJsonObject obj;
        if (!path.isEmpty()) {
            auto fullPath = path;
            if (ed > 0) fullPath += "?ed=" + QString::number(ed);
    ...
    BuildResult xrayHttpUpgrade::Build() const {
        return {ExportToJson(), ""};
    }
    ...
    QString xrayGRPC::ExportToLink() const {
        QUrlQuery query;
    ...
    QJsonObject xrayGRPC::ExportToJson() const {
        QJsonObject obj;
    ...
    BuildResult xrayGRPC::Build() const {
        return {ExportToJson(), ""};
    }
    ...
    QString xrayStreamSetting::ExportToLink() const {
        QUrlQuery query;
    ...
    QJsonObject xrayStreamSetting::ExportToJson() const {
        QJsonObject object;
    ...
    QJsonObject xrayStreamSetting::ExportIdentity() const {
        QJsonObject object;
        object["network"] = network;
        object["security"] = security;
        if (security == "reality") {
    ...
    BuildResult xrayStreamSetting::Build() const {
