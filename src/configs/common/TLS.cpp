...
namespace Configs {
    ...
    QString uTLS::ExportToLink() const
    {
        QUrlQuery query;
        if (!enabled) return "";
    ...
    QJsonObject uTLS::ExportToJson() const
    {
        QJsonObject object;
    ...
    QJsonObject uTLS::ExportIdentity() const
    {
        QJsonObject object;
        if (enabled && !fingerPrint.isEmpty()) object["fingerprint"] = fingerPrint;
        return object;
    }
    BuildResult uTLS::Build() const
    {
        if (!supported) return {};
    ...
    QString ECH::ExportToLink() const
    {
        QUrlQuery query;
        if (!enabled) return "";
    ...
    QJsonObject ECH::ExportToJson() const
    {
        QJsonObject object;
        if (!enabled) return object;
        object["enabled"] = enabled;
    ...
    QJsonObject ECH::ExportIdentity() const
    {
        QJsonObject object;
        if (enabled) object["enabled"] = true;
        return object;
    }
    BuildResult ECH::Build() const
    {
        return {ExportToJson(), ""};
    }
    ...
    QString Reality::ExportToLink() const
    {
        QUrlQuery query;
        if (!enabled) return "";
    ...
    QJsonObject Reality::ExportToJson() const
    {
        QJsonObject object;
        if (!enabled) return object;
        object["enabled"] = enabled;
    ...
    QJsonObject Reality::ExportIdentity() const
    {
        QJsonObject object;
        if (enabled) object["enabled"] = true;
        return object;
    }
    BuildResult Reality::Build() const
    {
        QJsonObject object;
    ...
    bool TLS::ParseFromLink(const QString& link)
    {
        ...
        if (query.hasQueryItem("security")) {
            const auto v = query.queryItemValue("security");
            enabled = (v == "tls" || v == "reality" || v == "1" || v == "true");
        }
    ...
    QString TLS::ExportToLink() const
    {
        QUrlQuery query;
        if (!enabled) return "";
    ...
    QJsonObject TLS::ExportToJson() const
    {
        QJsonObject object;
        if (!enabled) return object;
        object["enabled"] = enabled;
    ...
    QJsonObject TLS::ExportIdentity() const
    {
        QJsonObject object;
        if (!enabled) return object;
        object["enabled"] = true;
    ...
    bool TLS::FragmentEffectivelyOn() const
    {
    ...
    bool TLS::TlsTricksEffectivelyOn() const
    {
