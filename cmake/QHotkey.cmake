...
if(APPLE)
    ...
    # Vendor Carbon include path floods SDK deprecation/nullability noise.
    if(CMAKE_CXX_COMPILER_ID MATCHES "Clang|AppleClang")
        set_source_files_properties(3rdparty/QHotkey/qhotkey_mac.cpp PROPERTIES
            COMPILE_OPTIONS "-Wno-deprecated-declarations;-Wno-nullability-completeness;-Wno-deprecated-anon-enum-enum-conversion")
    endif()
elseif(WIN32)
