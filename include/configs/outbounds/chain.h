...
namespace Configs
{
    class chain : public outbound
    {
        ...
        QString DisplayType() const override { return QObject::tr("Chain Proxy"); };

        QString DisplayAddress() const override { return ""; };

        // No security of its own; it inherits whatever its hops use.
        SecurityInfo GetSecurity() const override { return {}; }
