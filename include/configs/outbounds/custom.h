...
namespace Configs
{
    ...
    public:
        ...
        bool IsXray() const override { return type == CustomXrayOutbound; }

        bool IsXrayFullConfig() const override { return type == CustomXrayFullConfig; }
        ...
        // out literal IPs.
        QStringList GetXrayFullConfigServerDomains() const {
            QStringList domains;
