...
namespace Stats
{
    ...
    public:
        ...
        ConnectionSort getSort() const;

    private:
        void Loop(std::stop_token stopToken);

        void updateWithResponse(const libcore::QueryConnectionsResp& resp);
        ...
        // interval; SetInView(true) / Stop() wake it early. inView_ selects the
