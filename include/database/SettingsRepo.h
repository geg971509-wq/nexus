...
namespace Configs {
    ...
    public:
        ...
        bool session_system_proxy = false;
        bool session_vpn = false;
        ...
        int vpn_mtu = 1500;
        // Positive: true = LAN/private ranges bypass Tun at OS route level (default).
        // DB key is "private_range_bypass"; old "disable_private_range_bypass" is load-compat inverted.
        bool private_range_bypass = true;
        bool vpn_ipv6 = false;
        ...
        QString warp_device_id = "";
        QString warp_access_token = "";
        QString warp_license = "";
        QString warp_local_public_key = "";
        QString warp_account_state = "";
        ...
        // macOS Tun cannot use type=local; default a public resolver so first Tun start works.
#ifdef Q_OS_MACOS
        QString core_box_underlying_dns = "1.1.1.1";
#else
