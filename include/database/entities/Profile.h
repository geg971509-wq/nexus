...
namespace Configs {
    ...
    public:
        ...
        // Shared across TrafficLooper / speedtest credit / SaveTraffic / UI.
        // Profiles are shared_ptr-only; atomics are non-copyable by design.
        std::atomic<qint64> traffic_downlink{0};
        std::atomic<qint64> traffic_uplink{0};
        ...
        Profile() = default;
        Profile(const std::shared_ptr<Configs::outbound> &outbound, const QString &type_);
